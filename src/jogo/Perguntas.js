...
class Perguntas extends Component {
    ...
    carregaPerguntas(categoria){
        this.setState({
            estaCarregando: true,
            perguntas: {}
        })
        const url = `https://miiosimura-projeto-quiz-react.firebaseio.com/categorias.json?orderBy="nome"&equalTo="${categoria}"`
        axios
            .get(url)
            .then(dados => {
                ...
                this.setState({
                    ...
                    totalPerguntas: _.size(listaDePerguntas.perguntas)
                })
            })
            .catch(err => {
    ...
    render(){
        ...
        return (
            <div>
                ...
                <Button onClick={this.proximaPergunta}>Próximo</Button>
            </div>
        )
    }
}
